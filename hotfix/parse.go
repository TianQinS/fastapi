...
const (
	model = `// Code generated by automatic for '{{.PkgName}}'. DO NOT EDIT.
...
{{end}}
`
	StdContent = `// Code generated by automatic. DO NOT EDIT.
package stdlibs
...
func Parse(outDir string, pkgs ...string) {
	// dir, err := os.Getwd()
	// dest := path.Base(dir)
	license := ""
	dest := "stdlibs"
	...
	for _, pkg := range pkgs {
		...
		err = ioutil.WriteFile(path.Join(outDir, prefix+"_"+oFile), content, 0666)
		if err != nil {
			log.Fatal(err)
		}
	}
